...
- Projects : ⚓ <b>Titanic</b> (Python: pandas, numpy, matplotlib), <b>Superstore Analysis</b> (Python: pandas, numpy, matplolib, seaborn), <b>2015 Flight Delays and Cancellations</b> (Tableau)
